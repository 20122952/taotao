...
public class TestActiveMq {
	...
	public void testQueueProducer() throws Exception {
		...
		ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://192.168.99.55:61616");
		...
		// 7.创建一个TextMessage对象
		TextMessage textMessage = session.createTextMessage("hello activeMQ1asdasdasd1");
		// 8.发送消息
